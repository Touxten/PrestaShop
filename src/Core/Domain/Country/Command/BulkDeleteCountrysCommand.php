...
/**
 * Deletes given countrys
 */
class BulkDeleteCountrysCommand
{
    /**
     * @var CountryId[]
     */
    ...
    {
        if (empty($countryIds)) {
            throw new CountryConstraintException('At least one country must be provided for deleting', CountryConstraintException::INVALID_ID);
        }
